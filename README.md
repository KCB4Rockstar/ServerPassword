...
Output jar: `build/libs/serverpass-1.4.0+26.2.jar`.
...
3. Put `serverpass-1.4.0+26.2.jar` in `mods/` too - it works unmodified on 26.1, 26.1.1, 26.1.2, and 26.2 (every API it touches was checked identical across all four).
